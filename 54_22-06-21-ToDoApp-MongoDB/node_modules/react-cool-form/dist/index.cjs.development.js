...
var useForm = (function (_temp) {
  ...
  var handleUnset = react.useCallback(function (path, options) {
    var segs = path.split(".");
    var k = segs.shift();
    setStateRef(k, unset(stateRef.current[k], segs.join("."), true), _extends__default['default']({
      fieldPath: path
    }, options));
  ...
  var getFields = react.useCallback(function (form) {
    return Array.from(form.querySelectorAll("input,textarea,select")).filter(function (element) {
      ...
      acc.set(name, _extends__default['default']({}, acc.get(name), {
  ...
  var setDefaultValue = react.useCallback(function (name, value, shouldUpdateDefaultValue) {
    ...
    if (!lite.dequal(get(stateRef.current.values, name), value)) setStateRef("values." + name, value, {
  ...
  var runAllBuiltInValidation = react.useCallback(function () {
    ...
    return Array.from(fieldsRef.current.keys()).reduce(function (errors, name) {
      ...
      errors = _extends__default['default']({}, errors, error ? set(errors, name, error) : {});
      return errors;
    }, {});
  ...
  var runAllFieldsValidation = react.useCallback(function () {
    ...
    return Promise.all(promises).then(function (errors) {
      return Object.keys(fieldValidatorsRef.current).reduce(function (acc, cur, idx) {
        acc = _extends__default['default']({}, acc, errors[idx] ? set(acc, cur, errors[idx]) : {});
        return acc;
      }, {});
    });
  }, [runFieldValidation]);
  ...
  var getFormState = react.useCallback(function (path, _temp3) {
  ...
  var use = react.useCallback(function (path, _temp4) {
    ...
    return getFormState(path, {
      ...
      callback: function callback(usedState) {
        observersRef.current[0].usedState = _extends__default['default']({}, observersRef.current[0].usedState, usedState);
      }
    });
  ...
  var setTouched = react.useCallback(function (name, isTouched, _temp5) {
    if (isTouched === void 0) {
      isTouched = true;
    }
  ...
  var setValue = react.useCallback(function (name, value, _temp6) {
  ...
  var removeField = react.useCallback(function (name, exclude) {
    var _arrayToMap = arrayToMap(exclude || [], {
      ...
      error: "errors"
        ...
        rest = _objectWithoutPropertiesLoose__default['default'](_arrayToMap, _excluded$1);
  ...
  var registerField = react.useCallback(function (value) {
    return function (field) {
      ...
      var validator = value.validate,
          parsers = _objectWithoutPropertiesLoose__default['default'](value, _excluded2$1);
...
var useFormState = (function (path, configOrCallback, formId) {
  ...
  return getFormState(path, _extends__default['default']({}, config, {
...
var useControlled = (function (name, _temp) {
  ...
  var _onChange = props.onChange,
      ...
      restProps = _objectWithoutPropertiesLoose__default['default'](props, _excluded2);
...
var useFieldArray = (function (name, _temp) {
  ...
  var setState = react.useCallback(function (handler, _temp2) {
    ...
    ["values", "touched", "errors", "dirty"].forEach(function (key) {
      ...
      if (key === "values" || key === "touched" && shouldTouched || key === "dirty" && shouldDirty || !isUndefined(value)) state = set(state, key, _extends__default['default']({}, state[key], (_extends2 = {}, _extends2[name] = handler(Array.isArray(value) ? [].concat(value) : [], key, fieldsLength ? fieldsLength - 1 : 0), _extends2)), true);
    });
    setStateRef("", _extends__default['default']({}, state, {
